function [datout,datcol] = addSolvent(datin,solvent,N,minDist=1.0,flags=[true,true,true,true,true])
  ...
  for i=1:N,
    ...
    datout = comblmp(datout,solvent,flags); #WARNING: velocities are discarder and the box modified
    datcol{i} = comblmp(datin,solvent,flags);
